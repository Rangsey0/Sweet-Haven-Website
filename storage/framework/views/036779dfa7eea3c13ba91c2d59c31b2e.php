...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center">
                ...
                <label class="ml-2 text-sm text-gray-600" for="remember_me"><?php echo e(__('Remember me')); ?></label>
            </div>
            <div>
...
<?php endif; ?>
<?php /**PATH D:\Rangsey\Y3S2\WCTII\ForPostGit\SweetHaven\resources\views/auth/login.blade.php ENDPATH**/ ?>