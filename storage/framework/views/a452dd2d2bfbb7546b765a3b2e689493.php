...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown','data' => ['align' => 'right','width' => '500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['align' => 'right','width' => '500']); ?>
...
<?php endif; ?>
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start pt-5" style="width: 200px;" id="menu">
                  ...
                  <li class="nav-item">
                      <a class="nav-link text-white" href="<?php echo e(route('admin.users.index')); ?>">
                          <div class="d-flex align-items-center">
...
</div><?php /**PATH D:\Rangsey\Y3S2\WCTII\ForPostGit\SweetHaven\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>